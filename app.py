...
def load_and_clean_data():
    ...
    try:
        # FINALER PFAD-FIX FÜR RENDER:
        # Wir ermitteln den Ordner, in dem DIESE Datei (app.py) liegt.
        ...
        # Datenbereinigung (Leerzeichen entfernen, Zahlen erzwingen)
...
def run_optimization():
    ...
    if not DATA_LOADED:
        ...
        if not DATA_LOADED:
            return jsonify({
                "status": "FATAL ERROR",
                "message": f"Server Error: Database file not found or unreadable.",
    ...
    # --- Lösen ---
    try:
        # Universeller Solver für Linux/Render
