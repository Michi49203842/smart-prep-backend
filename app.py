...
import pulp
# WICHTIG: Wir importieren den universellen Solver für Linux (Render)
...
# --- 1. DATEN VORBEREITEN ---
try:
    # Robuste Pfad-Suche: Findet die Datei egal ob lokal oder auf dem Server
    try:
    ...
    if pulp.LpStatus[prob.status] == "Optimal":
        ...
        for v in prob.variables():
            if pulp.value(v) > 0.001:
                # Namen bereinigen (Unterstriche weg)
